...
import { MENEGER_NAME } from '../../utils/constants';
      ...
      <div className={styles.container}>
        <div className={styles.terminal}>
          <div className={styles.header}>
            <span className={styles.project}>PROJECT: CINEMA_v3</span>
            <span className={styles.status}>Статус: НА УТВЕРЖДЕНИИ</span>
          </div>

          <div className={styles.content}>
            <div className={styles.line}>
              <span className={styles.prompt}>$</span> Для: {MENEGER_NAME}
            </div>
          ...
          <div className={styles.footer}>
            <span className={styles.footerLeft}>⌨️ v3.0</span>
            <span className={styles.footerRight}>БЕЗ ПРАВ И ОГРАНИЧЕНИЙ</span>
          </div>
        </div>
      </div>
